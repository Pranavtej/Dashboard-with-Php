                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                             ...
                             <!-- //if(isset($_SESSION['name'])): -->
                               <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">Welcome !' echo '<h1>'.$Name.'</h1>'/span><img class="border rounded-circle img-profile" src="assets/img/avatars/avatar1.jpeg"></a> 
                                ...
                                <div class="col-lg-6 mb-4">
                                    <div class="card textwhite bg-primary text-white shadow">
                                        <div class="card-body">
                                            ...
                                            <p class="text-white-50 small m-0" style="font-size: 24px;">37</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-4">
                                    <div class="card textwhite bg-success text-white shadow">
                                        <div class="card-body">
                                            <p class="m-0">Projects On Going</p>
                                            <p class="text-white-50 small m-0" style="font-size: 25px;">3</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
